...
> 初次批准日期：2026-07-21
>
> 最近范围确认：2026-08-06（文件规模治理调整为 500 行语义复核与 2000 行硬门禁，见 ADR-20260806-003；异步优先、Tracing 落盘可读日志与产出物真实可用验收见 ADR-20260806-002；Tauri GUI 界面国际化约束见 ADR-20260806-001）
