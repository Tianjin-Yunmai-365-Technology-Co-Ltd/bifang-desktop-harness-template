...
本目录是符合本项目触发规则的用户和维护者可感知变化的唯一正文来源；本项目不使用普通缺陷修复的 `Fixed` 类别。Harness 版本使用 `Version.md` 声明的上海时区 `YYYYMMDDHHMM`；下游产品按 `docs/RELEASE.md` 与 `$desktop-manage-version` 自动管理三段语义化版本。
...
- [2026-09-02](20260902_CHANGELOG.md)
