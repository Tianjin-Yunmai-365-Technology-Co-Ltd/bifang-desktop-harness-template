...
- 推荐预设把 `user_owned_tasks` 固定物化为默认关闭；选择自定义时与 `superpowers`、`parallel_worktree_subagents`、`milestone_smoke`、`milestone_e2e` 一样逐项确认，并以 Agent Policy schema v2 的五项策略原子保存。
