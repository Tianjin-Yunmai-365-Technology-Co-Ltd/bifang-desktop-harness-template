...
| LIM-009 | 条件开发环境自动安装尚未完成三平台原生前向验证 | 仅 Rust 与 GUI 条件门禁已有 Unix 隔离覆盖，但真实 pnpm 软件包仓库、Windows PowerShell、权限、PATH、MSVC 和宿主架构仍可能阻断 | 在受控的 Windows、macOS、Linux 干净宿主分别运行仅 Rust 与 GUI 门禁并记录 Rust、Node.js、pnpm、MSVC 安装与复验 | Open |
