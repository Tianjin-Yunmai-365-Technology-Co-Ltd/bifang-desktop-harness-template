...
def primary_required_fragments(
    ...
    return {
        ...
        skill_file: (
            ...
            "底部固定项按视觉顺序为赞助、设置、关于",
            "更新显示 `NotConfigured`",
            "每个功能项和赞助/设置/关于固定项必须提供图标",
            "折叠时显示图标和本地化 Tooltip 名称",
            "浅色/深色/跟随系统",
            "关于页提供手动检查更新",
        ...
        REACT_BASELINE: (
            ...
            "初始化固定建立默认收起的左侧菜单、`/settings`、`/about`、`/sponsor`",
            "两者在侧栏两种状态都直接可见",
            "底部组按赞助、设置、关于渲染",
            "真实更新、强更或统计上报",
            "作者、联系方式和三段免责声明",
        ...
        GUI_BASELINE: (
            ...
            "可见图形而非空白点击区域",
            "`{applicationName} {version} {contactChannel}:{contactValue}`",
            "初始化固定建立默认收起的左侧菜单与 `/settings`、`/about`、`/sponsor` 文件路由",
            "底部固定组按视觉顺序为赞助、设置、关于",
            "统计上报默认关闭",
            "签名验证不可关闭",
            "作者、作者联系方式和三段免责声明",
