...
def core_first_requirements() -> dict[Path, tuple[str, ...]]:
    ...
    return {
        ...
        MANTINE_LIST_VIEW_SKILL: (  # noqa: F405
            ...
            "[10, 20, 50, 100]",
            "浅/深/浅/深",
            "必须显式设置 `required: true`",
            "placeholder 旧行是只读展示",
            "@mantine/core >=9.6.1 <10",
            "@tanstack/react-query >=5.102.8 <6",
            "@dnd-kit/core",
            "Required",
        ),
        ROOT / "docs" / "design_standards" / "mantine_list_view.md": (  # noqa: F405
            "standard_id = mantine-list-view-v2",
            "canonical URL 在首次查询前以一次 `replace` 写回",
            "服务端默认排序必须确定",
            "浅色主题：浅行为",
        ...
        MANTINE_LIST_VIEW_API: (  # noqa: F405
            ...
            "withEdges",
            "getControlProps",
            "placeholderData` 只在新 key pending 时提供旧值",
        ),
        ...
        MANTINE_LIST_VIEW_TEMPLATE: (  # noqa: F405
            ...
            "VisuallyHidden",
            "claimListCorrection",
            "backgroundErrorPresentation",
        ),
        MANTINE_LIST_VIEW_STATE: (  # noqa: F405
            ...
            "schemaVersion 只属于 payload",
            "requires unique column ids",
            "exactly one primary business column",
            "page items exceed the remaining total",
            "validateBusinessIds",
        ...
        MANTINE_LIST_VIEW_TYPES: (  # noqa: F405
            "responsiveRole 用于失败关闭窄屏关键内容丢失",
            "businessIdType",
        ...
        MANTINE_LIST_VIEW_COLUMN_SETTINGS: (  # noqa: F405
            "KeyboardSensor",
            "onDragStart:",
            "onDragCancel:",
        ...
        MANTINE_LIST_VIEW_CONTRACT_TEST: (  # noqa: F405
            ...
            "claimListCorrection",
            "getEffectiveCurrentPageSelection",
            "mantine-list-view executable contracts passed",
        ),
