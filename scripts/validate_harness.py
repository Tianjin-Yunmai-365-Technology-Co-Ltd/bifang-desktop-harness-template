...
def main() -> int:
    ...
    print(
        ...
        "opt-in plans, minimal development checks, local-install/release-candidate separation, per-candidate E2E selection and full unit suites, budgeted progressive AGENTS routing, persistent Agent policy, release/build routing, initialization gates, engineering rules, "
