...
def main() -> int:
    ...
    print(
        ...
        "opt-in plans, minimal development checks, per-build E2E selection and full unit suites, budgeted progressive AGENTS routing, persistent Agent policy, release/build routing, initialization gates, engineering rules, "
